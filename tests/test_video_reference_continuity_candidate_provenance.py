...
def test_continuity_benchmark_rejects_candidate_revision_mismatch(tmp_path: Path) -> None:
    ...
    actual_revision = "926299962ed32a142411e45468a289623432b4e4"
    ...
    evidence = ReferenceContinuityBenchmark(
        candidate_id="lightx2v-wan22-i2v",
        candidate_revision="different-revision",
