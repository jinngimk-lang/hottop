...
def list(
    ...
    include_nonexecutable: bool = typer.Option(False, "--include-nonexecutable"),
    include_paid: bool = typer.Option(False, "--include-paid"),
) -> None:
    """List safe model-hub candidates; this command never installs, downloads or executes models."""
    ...
    entries = select_models(
        ...
        executable_only=not include_nonexecutable,
    )
    typer.echo(
        json.dumps(
