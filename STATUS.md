...
Latest verified evidence point: **`main@e5904c60716670ecb86d1425a625dbb9098d2139` / CI #2400** on Python 3.11/3.12. The merge closes the Pure-C Qwen3-TTS 1.7B safetensors metadata-consistency gaps described below. Every later recovery must still re-fetch live `main`, open PRs and exact-head CI before treating this historical evidence point as current.
