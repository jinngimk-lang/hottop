...
Latest verified evidence point: **`main@44779086804ef9c734909447c8cc3bf01eb4f9d4` / CI #2384** on Python 3.11/3.12. The merge closes the Pure-C Qwen3-TTS 1.7B safetensors false-ready described below. Every later recovery must still re-fetch live `main`, open PRs and exact-head CI before treating this historical evidence point as current.
